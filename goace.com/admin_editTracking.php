...
$view2 = "SELECT * from track where cust_id = '$custId'";
...
if(isset($_POST['update'])){
    ...
    $trackNo= addslashes($_POST['track_num']);
 

    $insert = "UPDATE track set track_num = '$trackNo' WHERE track_id=$track_id";
...
?>
    ...
    <td><input type="hidden" id="txtbox" name="track_id" value="<?php echo $row2['track_id'];?>" required><?php echo $row2['track_id'];?></td>
    </tr>

    <tr>
    <td align="right">Tracking Number:</td>
    <td><input type="text" id="txtbox" name="track_num" value="<?php echo $row2['track_num'];?>" ></td>
    </tr>
