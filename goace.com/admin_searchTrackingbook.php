...
<html>
    <head>
      ...
      <td width="741" align="right">
        ...
        <input type="text" name="query" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="Search booking id..." /><input type="submit" id="btnsearch" value="Search" name="search" style="width:100px; height:30px; color:#FFF; background:#4B0082; border:1px solid #4B0082; border-radius:3px;">
        </form>
        </center>
        </td>
      <hr>
...
<?php
    ...
    $sql = "select * from booking where book_id like '%".$query."%' ";
            ...
            <td><center>
             <?php  
                  ...
                  if($result3->num_rows > 0) {
                       ...
                       ?>
                          <center><a href="admin_dmdetails2.php?dm_id=<?php echo $row3['dm_id'];?>"><?php echo $row3['dm_id'];?></a>
                      ...
                      <center><a href="admin_dmdetails.php?dm_id=<?php echo $row2['dm_id'];?>&book_id=<?php echo $row['book_id'];?>"><input type="button" value="<?php echo $row2['dm_id'];?>" style="width:60px; height:20px; color:#FFF; background:#696969; border:1px solid #696969; border-radius:3px;"></a><br>
