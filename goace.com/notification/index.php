      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          if(isset($_POST['submit'])){
			  ...
			  $r_id = $_POST['r_id'];
              $query ="INSERT INTO `notifications` (`id`, `type`, `message`, `status`, `date`, `r_id`) VALUES (NULL, 'assign', '$message', 'unread', CURRENT_TIMESTAMP, '$r_id')";
        ...
        <form method="post" class="form-inline my-2 my-lg-0">
		  ...
		  <input name="r_id"class="form-control mr-sm-2" type="text" placeholder="Rider ID" required>
          <button name="submit" class="btn btn-outline-success my-2 my-sm-0" type="submit">Send</button>
        </form> | 
